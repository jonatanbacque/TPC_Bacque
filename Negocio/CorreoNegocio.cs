...
namespace Negocio
{
    public class CorreoNegocio
    {
        ...
        public string encabezado = "<html lang=es>" +
                        "<head>" +
            ...
            try
            {
                if (usuario != null)
                {
                    ...
                    string body = encabezado +
                        "<h5> Estimad@ " + usuario.persona.Apellido + " " + usuario.persona.Nombre + " recibimos su registro.</h5>" +
                        "<br/>" +
                        "<h6> Su usuario es " + usuario.Nombre + ".</h6>" +
                        "<br/>" +
                        "<h6> Su password es " + usuario.Password + ".</h6>" +
                        "<br/>" +
                        "<h6> Esperamos tenga una grata experiencia de compra.</h6>" + firma;
