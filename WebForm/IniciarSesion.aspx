            ...
            <asp:Panel CssClass="form-row" DefaultButton="btnIngresar" runat="server">
                <div class="form-group col-md-4 center_div">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtContrasena1" TextMode="Password" CAutoPostBack="true" ssClass="form-control" runat="server" />
                    </div>
                    <div class="form-group">
                        <asp:Label for="txtContrasena2" Text="Repita Contraseña" runat="server" />
                        <asp:TextBox ID="txtContrasena2" TextMode="Password" AutoPostBack="true" CssClass="form-control" runat="server" />
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group col-md-4 center_div">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtContrasena" TextMode="Password" AutoPostBack="true" CssClass="form-control" runat="server" />
                    </div>
                    <div class="form-group">
